...
func BotChatHistoryClearHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotChatHistoryClearReq
		...
		l := logic.NewBotChatHistoryClearLogic(r.Context(), svcCtx)
		resp, err := l.BotChatHistoryClear(&req)
