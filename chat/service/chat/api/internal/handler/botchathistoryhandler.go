...
func BotChatHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotChatHistoryReq
		...
		l := logic.NewBotChatHistoryLogic(r.Context(), svcCtx)
		resp, err := l.BotChatHistory(&req)
