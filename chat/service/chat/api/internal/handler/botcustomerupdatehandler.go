...
func BotCustomerUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotCustomUpdateReq
		...
		l := logic.NewBotCustomerUpdateLogic(r.Context(), svcCtx)
		resp, err := l.BotCustomerUpdate(&req)
