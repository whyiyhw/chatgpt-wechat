...
func BotDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotDeleteReq
		...
		l := logic.NewBotDeleteLogic(r.Context(), svcCtx)
		resp, err := l.BotDelete(&req)
