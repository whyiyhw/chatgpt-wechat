...
func BotExploreListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotExploreListReq
		...
		l := logic.NewBotExploreListLogic(r.Context(), svcCtx)
		resp, err := l.BotExploreList(&req)
