...
func BotKnowledgeUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotKnowledgeUpdateReq
		...
		l := logic.NewBotKnowledgeUpdateLogic(r.Context(), svcCtx)
		resp, err := l.BotKnowledgeUpdate(&req)
