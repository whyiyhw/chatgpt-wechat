...
func BotModelUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotModelUpdateReq
		...
		l := logic.NewBotModelUpdateLogic(r.Context(), svcCtx)
		resp, err := l.BotModelUpdate(&req)
