...
func BotPromptUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotPromptUpdateReq
		...
		l := logic.NewBotPromptUpdateLogic(r.Context(), svcCtx)
		resp, err := l.BotPromptUpdate(&req)
