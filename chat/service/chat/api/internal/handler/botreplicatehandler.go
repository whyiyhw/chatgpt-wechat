...
func BotReplicateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotReplicateReq
		...
		l := logic.NewBotReplicateLogic(r.Context(), svcCtx)
		resp, err := l.BotReplicate(&req)
