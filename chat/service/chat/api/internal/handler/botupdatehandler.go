...
func BotUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BotUpdateReq
		...
		l := logic.NewBotUpdateLogic(r.Context(), svcCtx)
		resp, err := l.BotUpdate(&req)
