...
func KnowledgeCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeCreateReq
		...
		l := logic.NewKnowledgeCreateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeCreate(&req)
