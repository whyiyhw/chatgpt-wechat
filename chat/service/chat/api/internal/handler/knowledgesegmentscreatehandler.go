...
func KnowledgeSegmentsCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeSegmentsCreateReq
		...
		l := logic.NewKnowledgeSegmentsCreateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeSegmentsCreate(&req)
