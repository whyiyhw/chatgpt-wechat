...
func KnowledgeSegmentsDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeSegmentsDeleteReq
		...
		l := logic.NewKnowledgeSegmentsDeleteLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeSegmentsDelete(&req)
