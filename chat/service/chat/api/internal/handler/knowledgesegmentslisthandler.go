...
func KnowledgeSegmentsListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeSegmentsListReq
		...
		l := logic.NewKnowledgeSegmentsListLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeSegmentsList(&req)
