...
func KnowledgeSegmentsUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeSegmentsUpdateReq
		...
		l := logic.NewKnowledgeSegmentsUpdateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeSegmentsUpdate(&req)
