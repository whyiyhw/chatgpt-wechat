...
func KnowledgeUnitCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUnitCreateReq
		...
		l := logic.NewKnowledgeUnitCreateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUnitCreate(&req)
