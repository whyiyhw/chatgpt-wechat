...
func KnowledgeUnitDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUnitDeleteReq
		...
		l := logic.NewKnowledgeUnitDeleteLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUnitDelete(&req)
