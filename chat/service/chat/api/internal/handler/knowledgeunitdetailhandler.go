...
func KnowledgeUnitDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUnitDetailReq
		...
		l := logic.NewKnowledgeUnitDetailLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUnitDetail(&req)
