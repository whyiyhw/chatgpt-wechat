...
func KnowledgeUnitListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUnitListReq
		...
		l := logic.NewKnowledgeUnitListLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUnitList(&req)
