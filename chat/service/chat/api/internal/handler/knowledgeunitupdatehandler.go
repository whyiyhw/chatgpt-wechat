...
func KnowledgeUnitUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUnitUpdateReq
		...
		l := logic.NewKnowledgeUnitUpdateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUnitUpdate(&req)
