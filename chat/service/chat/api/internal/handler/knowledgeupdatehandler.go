...
func KnowledgeUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.KnowledgeUpdateReq
		...
		l := logic.NewKnowledgeUpdateLogic(r.Context(), svcCtx)
		resp, err := l.KnowledgeUpdate(&req)
