...
type KnowledgeUnitUpdateLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewKnowledgeUnitUpdateLogic(ctx context.Context, svcCtx *svc.ServiceContext) *KnowledgeUnitUpdateLogic {
	return &KnowledgeUnitUpdateLogic{
...
func (l *KnowledgeUnitUpdateLogic) KnowledgeUnitUpdate(req *types.KnowledgeUnitUpdateReq) (resp *types.KnowledgeUnitUpdateReply, err error) {
